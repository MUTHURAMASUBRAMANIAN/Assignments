...
with tab_explore:
    ...
    st.caption(
        "Adjust the levers below to see how they change the delay risk for the shipment you "
        "just predicted in the Predict tab — this is where to explore options to avoid the delay."
    )
